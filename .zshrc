...
SPACESHIP_NODE_DEFAULT_VERSION=v11.7.0
...
plugins=(zsh-nvm zsh-autosuggestions tmux autoenv git npm yarn osx z alias-tips thefuck rbenv pyenv zsh-iterm-touchbar zsh-syntax-highlighting)
